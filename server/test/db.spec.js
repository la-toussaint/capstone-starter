...
describe("Database", () => {
  ...
  describe("Routines", () => {
    ...
    describe("getAllTemplateRoutines", () => {
      let routine;
      beforeAll(async () => {
        [routine] = await getAllTemplateRoutines();
      });
    ...
    describe("getTemplateRoutinesByUser", () => {
      let routine, user;
      beforeAll(async () => {
        user = await getUserById(1);
        [routine] = await getTemplateRoutinesByUser(user);
      });
    ...
    describe("getTemplateRoutinesByActivity", () => {
      let routine, activity;
      beforeAll(async () => {
        activity = await getActivityById(3);
        [routine] = await getTemplateRoutinesByActivity(activity);
      });
    ...
    describe("updateRoutine", () => {
      ...
      it("Updates the public status, name, or goal, as necessary", async () => {
        expect(routineToCreateAndUpdate.isTemplate).toBe(
          queriedRoutine.isTemplate
        );
